...
class DataManager:
    ...
    def _get_language_annoy_index_path(self, language: str):
    ...
    def get_language_annoy_index(self, annoy_index, language: str):
        return serialize.load('annoy', self._get_language_annoy_index_path(language), annoy_index=annoy_index)

    def save_language_annoy_index(self, annoy_index, language: str):
        return serialize.serialize(annoy_index, 'annoy', self._get_language_annoy_index_path(language))
